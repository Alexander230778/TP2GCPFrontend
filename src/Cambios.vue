                ...
                <fieldset :disabled="disabledForm">
                    ...
                    <b-form-group>
                        <b-form-select @change="changePortafolio"
                            ...
                            <template slot="first">
                                ...
                                <option :value="form.NumPortafolio || null" disabled>{{form.por_Nombre || '-- Seleccione un portafolio --'}}</option>
                            </template>
                        </b-form-select>
                    </b-form-group>
                    ...
                    <b-form-group
                        ...
                        <b-form-select id="tipo"
                            ...
                            <template slot="first">
                                <option :value="form.pro_Codigo || null" disabled>{{form.pro_Nombre ||'-- Seleccione un proyecto --'}}</option>
                            </template>
                        </b-form-select>
                    </b-form-group>
